  ...
  <title>Practica sesiones</title>
	...
	if ($_SERVER['REQUEST_METHOD'] === 'POST') {
		...
		if (isset($_POST['almacenContactos']) && strlen($_POST['almacenContactos']) > 1) {
			...
			if (isset($_SESSION['almacenContactos'])) {
				$_SESSION['almacenContactos'] = $almacenContactos;
				$_SESSION['almacenNumeros'] = $almacenNumeros;			
			} else {
				$_SESSION['almacenContactos'] = "";
				$_SESSION['almacenNumeros'] = "";
			}
		}
